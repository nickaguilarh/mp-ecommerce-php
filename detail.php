...
$preference->back_urls = array(
    "success" => "https://nickaguilarh-mp-commerce-php.herokuapp.com/success.php",
    "failure" => "https://nickaguilarh-mp-commerce-php.herokuapp.com/failure.php",
    "pending" => "https://nickaguilarh-mp-commerce-php.herokuapp.com/pending.php"
);
$preference->items = array($item);
$preference->auto_return = "approved";
$preference->external_reference = "nickaguilarh@gmail.com";
$preference->notification_url = "https://nickaguilarh-mp-commerce-php.herokuapp.com/notifications.php";
$preference->save();
?>
                                        ...
                                        <div class="clearfix image-list xs-no-js as-util-relatedlink relatedlink"
                                            ...
                                            <div class="as-tilegallery-element as-image-selected">
                                                ...
                                                <img src="./assets/003.jpg"
                                                     ...
                                                     height="445" style="content:-webkit-image-set(url(<?php
                                                echo $_POST['img'] ?>) 2x);">
                                            </div>
                                    ...
                                    <div class="as-producttile-title">
                                        <h3 class="as-producttile-name">
                                            <p class="as-producttile-tilelink">
                                                <span data-ase-truncate="2"><?php
                                                    echo $_POST['title'] ?></span>
                                            </p>
